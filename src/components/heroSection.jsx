      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
        ...
        <div className="space-y-6">
         ...
         <p className=' text-lg text-gray-600 max-w-lg'>
          Discover how AI is transforming industries and improving lives worldwide. Our cutting-edge 
          solutions harness the power of machine learning to solve complex problems.
         </p>
