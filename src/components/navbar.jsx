 ...
 const [mobileMenuOpen, setMobileMenuOpen] = useState(false);
  return (
    ...
    <a href="#" className='nav-btn' >Get Started</a>
      ...
      className='md:hidden p-2 rounded-md text-gray-400 hover:text-gray-500 hover: bg-gray-100 focus:outline'>
     ...
     {mobileMenuOpen && (
  <div className='md:hidden bg-white shadow-lg rounded-b-lg px-2 pt-2 pb-2 space-y-1'>
